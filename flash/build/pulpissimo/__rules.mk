...
test_FC_OBJS =     $(patsubst %.cpp,$(CONFIG_BUILD_DIR)/$(PULP_LIB_NAME_test)/fc/%.o, $(patsubst %.c,$(CONFIG_BUILD_DIR)/$(PULP_LIB_NAME_test)/fc/%.o, $(PULP_APP_FC_SRCS_test) $(PULP_FC_SRCS_test) $(PULP_APP_FC_SRCS) $(PULP_APP_SRCS) $(PULP_FC_EXTRA_SRCS_test)))
test_FC_ASM_OBJS = $(patsubst %.S,$(CONFIG_BUILD_DIR)/$(PULP_LIB_NAME_test)/fc/%.o, $(PULP_APP_FC_ASM_SRCS_test) $(PULP_FC_ASM_SRCS_test) $(PULP_APP_FC_ASM_SRCS) $(PULP_APP_ASM_SRCS) $(PULP_FC_EXTRA_ASM_SRCS_test))
test_FC_OMP_OBJS = $(patsubst %.c,$(CONFIG_BUILD_DIR)/$(PULP_LIB_NAME_test)/fc/omp/%.o, $(PULP_APP_FC_OMP_SRCS_test) $(PULP_FC_OMP_SRCS_test) $(PULP_APP_FC_OMP_SRCS) $(PULP_APP_OMP_SRCS) $(PULP_FC_EXTRA_OMP_SRCS_test))
